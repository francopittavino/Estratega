    ...
    <div className="flex flex-col gap-4">
        ...
        {status === "IN_PROGRESS" && (
          <div className="flex gap-2 flex-wrap">
            ...
            <button
              ...
              className="bg-primary text-white rounded-md shadow-md shadow-primary/20 px-4 py-2 text-sm font-medium hover:bg-primary-dark transition-colors disabled:opacity-60"
            >
              Terminar ronda
            </button>
            <button
      ...
      <ul className="flex flex-col gap-3">
        {participants.map((participant, index) => (
          <li
            key={participant.id}
            className="bg-card border border-border shadow-lg shadow-black/30 rounded-xl p-3 sm:p-4 flex flex-col gap-3"
          >
